...
namespace BookingTravel.Models
{
    ...
    public partial class Tour
    {
        ...
        [Display(Name = "Loai Tour")]
        [Required(ErrorMessage = "Loại Tour không được bỏ trống!")]
        public string LoaiTour { get; set; }

        [Display(Name = "Nơi khởi hành Tour")]
        [Required(ErrorMessage = "Nơi khởi hành không được bỏ trống!")]
