...
(
	...
	Tinh 		smallint null,
	KhachSan_ID	int NULL foreign key(KhachSan_ID) references KhachSan(ID),
	primary key (ID)
)
GO
...
(
	ID 					int IDENTITY(1,1) NOT NULL,
	NhanVien_ID 		int NULL foreign key(NhanVien_ID) references NhanVien(ID),
...
(
	...
	KhachHang_ID 	int NULL foreign key(KhachHang_ID) references KhachHang(ID),
	NoiDung 		ntext NULL,
	NgayDang 		datetime NULL,
	KiemDuyet 		tinyint NULL,/*0 chưa kiểm duyệt 1 đã kiểm duyệt*/
	PRIMARY KEY (ID)
...
(
	ID 					int IDENTITY(1,1) NOT NULL,
	PhuongTien_ID		int null foreign key(PhuongTien_ID) references PhuongTien(ID),
	/*DiaDiemThamQuan_ID	int null foreign key(DiaDiemThamQuan_ID) references DiaDiemThamQuan(ID),*/
	TenTour				nvarchar(255) NULL,
	LoaiTour			nvarchar(255) NULL,
	NoiKhoiHanh			nvarchar(255) NULL,	
	NgayBD				datetime null,
	NgayKT				datetime null,
	DonGia				int NULL,
	SoLuong 			int null,
	/*HinhAnhTour			nvarchar(255) NULL,*/
